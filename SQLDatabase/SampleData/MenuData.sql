INSERT INTO Menu(id, name, calories, category, available, price, description) VALUES
(DEFAULT, 'Taco al Pastor', 500, 'mains', true, 5.99, 'A popular street food in Mexico, made with marinated pork cooked on a spit and topped with pineapple, onions, and cilantro'),
(DEFAULT, 'Mole Poblano', 800, 'mains', true, 12.99, 'A traditional Mexican dish made with a complex sauce made from chili peppers and various spices, served over chicken'),
(DEFAULT, 'Tamales Oaxaquenos', 600, 'mains', true, 8.99, 'A traditional tamale from the Oaxaca region of Mexico, made with masa dough filled with pork and red mole sauce, wrapped in banana leaves'),
(DEFAULT, 'Enchiladas de Mole', 700, 'mains', true, 10.99, 'A traditional Mexican dish made with corn tortillas filled with chicken and topped with mole sauce and cheese, served with sour cream'),
(DEFAULT, 'Chiles Rellenos', 600, 'mains', true, 12.99, 'A traditional Mexican dish made with poblano peppers stuffed with ground beef and cheddar cheese, coated in egg batter and fried, topped with tomato sauce, cilantro, and onions.'),
(DEFAULT, 'Carne Asada', 800, 'mains', true, 14.99, 'A traditional Mexican dish made with grilled beef, served with cilantro, onions, lime, and corn tortillas.'),
(DEFAULT, 'Barbacoa', 800, 'mains', true, 15.99, 'A traditional Mexican dish of slow-cooked lamb, often served with cilantro, onions, and lime'),
(DEFAULT, 'Tostadas', 500, 'mains', true, 8.99, 'A popular Mexican dish consisting of a fried corn tortilla topped with beans, lettuce, cheese, and meat'),
...
(DEFAULT, 'Arroz Rojo', 200, 'sides', true, 2.99, 'Traditional Mexican red rice'),
(DEFAULT, 'Guacamole', 200, 'sides', true, 4.99, 'Homemade guacamole made fresh daily'),
(DEFAULT, 'Pico de Gallo', 50, 'sides', true, 3.99, 'Fresh salsa made with diced tomatoes, onions, cilantro, and lime juice'),
(DEFAULT, 'Queso Fundido', 400, 'sides', true, 7.99, 'Melted Chihuahua cheese mixed with chorizo, served with warm tortillas'),
(DEFAULT, 'Nachos', 500, 'sides', true, 7.99, 'Crispy tortilla chips topped with refried beans, cheese, jalapenos, and sour cream'),
...
(DEFAULT, 'Agua Fresca', 50, 'drinks', true, 2.99, 'A refreshing, non-alcoholic drink made from water and fresh fruit'),
(DEFAULT, 'Tequila Sunrise', 150, 'drinks', true, 7.99, 'A popular cocktail made with tequila, orange juice, and grenadine'),
(DEFAULT, 'Paloma', 150, 'drinks', true, 7.99, 'A traditional Mexican cocktail made with tequila, grapefruit soda, and lime juice'),
(DEFAULT, 'Margarita', 150, 'drinks', true, 7.99, 'A classic cocktail made with tequila, lime juice, and triple sec'),
(DEFAULT, 'Sangrita', 150, 'drinks', true, 4.99, 'A traditional Mexican non-alcoholic drink typically served as a chaser to tequila'),
